// On encapsule tout dans une fonction pour éviter les conflits avec d'autres scripts.
(function() {
    // --- CONFIGURATION ---
    ...
    // Injecte le CSS et les icônes dans la balise <head>
    ...
    // Injecte le HTML du chatbot dans la balise <body>
    document.body.insertAdjacentHTML('beforeend', chatbotHTML);

    // --- LOGIQUE DU CHATBOT ---
    // Puisque le script est chargé avec "defer", le DOM est prêt. 
    // On peut donc cibler les éléments directement.
